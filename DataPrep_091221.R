...
# Can export the dataset using write.csv command (Mac)
write.csv(append_sidebyside, "/Users/cinsbox/Desktop/append_sidebyside")

# Expot the dataset using write.csv commmand (PC)
write_csv(append_sidebyside, "C:\\Users\\cinsbox\\Desktop\\append_sidebyside.csv")
